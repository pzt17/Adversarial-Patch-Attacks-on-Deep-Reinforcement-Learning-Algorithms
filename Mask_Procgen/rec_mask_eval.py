...
from evaluate import rec_patch_evaluate_train
from evaluate import rec_patch_evaluate_test
...
if __name__ == '__main__':
    ...
    for i in range(10):
    	...
    	train_tem_reward = rec_patch_evaluate_train(configs, ppo_agent, train_venv, valid_venv, patch, x_pos, y_pos, gen_model)
    	eval_tem_reward = rec_patch_evaluate_test(configs, ppo_agent, train_venv, valid_venv, patch, x_pos, y_pos, gen_model)
