...
if __name__ == '__main__':
    ...
    train_mean, train_std = random_patch_evaluate_train(configs, ppo_agent, train_venv, valid_venv, patch, x_pos, y_pos)
    eval_mean, eval_std = random_patch_evaluate_test(configs, ppo_agent, train_venv, valid_venv, patch, x_pos, y_pos)
