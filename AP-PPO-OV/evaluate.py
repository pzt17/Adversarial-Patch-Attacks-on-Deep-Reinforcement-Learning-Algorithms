...
def train_test(config, agent, train_env, test_env, patch, pos_x, pos_y, pgd_epsilon=None, gwc_epsilon=None):
...
def eval_test(config, agent, train_env, test_env, patch, pos_x, pos_y, pgd_epsilon=None, gwc_epsilon=None):
...
def patch_train(config, agent, train_env, test_env, patch, pos_x, pos_y, replay_buffer, pgd_epsilon=None, gwc_epsilon=None):
    ...
    train_obs = train_env.reset()
    train_steps = np.zeros(config.num_envs, dtype = int)
    #replay_buffer = Qlay(config.replay_size)
